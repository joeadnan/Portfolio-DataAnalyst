...
export const certifications: Certification[] = [
  {
    ...
    imageUrl: "/certifications/excel-data-analysis.svg",
    description:
      "Mempelajari pengolahan data menggunakan Excel, pivot table, chart, lookup, data cleaning, dan pembuatan dashboard sederhana untuk kebutuhan reporting.",
    skills: ["Excel", "Pivot Table", "Chart", "Lookup", "Dashboard"],
  },
  {
    ...
    imageUrl: "/certifications/sql-data-analysis.svg",
    description:
...
export const documentationSamples = [
  {
    ...
    fileUrl: "/documents/sales-dashboard-analysis-notes.md",
  ...
  },
  {
    ...
    fileUrl: "/documents/data-cleaning-checklist.md",
  ...
  },
  {
    ...
    fileUrl: "/documents/sql-query-documentation.md",
  ...
  },
  {
    ...
    fileUrl: "/documents/dashboard-user-guide.md",
