      ...
      <div className="site-container">
        <Reveal>
          <SectionTitle
            ...
            title="Experience yang Relevan untuk Data Analyst"
            description="Pengalaman kerja sebelumnya diarahkan sebagai kekuatan transisi: problem solving, pencatatan data, dokumentasi, reporting, validasi informasi, dan komunikasi dengan user non-teknis."
          />
        </Reveal>
