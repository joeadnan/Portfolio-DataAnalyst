      ...
      <div className="site-container">
        <Reveal>
          <SectionTitle
            ...
            title="Why Hire Me?"
            description="Alasan mengapa saya siap dipertimbangkan untuk posisi Junior Data Analyst, Data Analyst Intern, Reporting Analyst, atau Business Intelligence Assistant."
          />
        </Reveal>
